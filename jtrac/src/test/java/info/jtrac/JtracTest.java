...
public class JtracTest extends JtracTestBase {
    ...
    public void testGeneratedPasswordIsAlwaysDifferent() {
        ...
        System.out.println("Completed test: testGeneratedPasswordIsAlwaysDifferent");
    }
    
    public void testEncodeClearTextPassword() {
        assertEquals("21232f297a57a5a743894a0e4a801fc3", jtrac.encodeClearText("admin"));
        System.out.println("Completed test: testEncodeClearTextPassword");
    ...
    public void testMetadataInsertAndLoad() {
        ...
        System.out.println("Completed test: testMetadataInsertAndLoad");
    }
    ...
    public void testUserInsertAndLoad() {
        ...
        System.out.println("Completed test: testUserInsertAndLoad");
    }
    ...
    public void testUserSpaceRolesInsert() {
        ...
        System.out.println("Completed test: testUserSpaceRolesInsert");
    }
    ...
    public void testConfigStoreAndLoad() {
        ...
        System.out.println("Completed test: testConfigStoreAndLoad");
    }
    ...
    public void testStoreAndLoadUserWithAdminRole() {
        ...
        System.out.println("Completed test: testStoreAndLoadUserWithAdminRole");
    }
    ...
    public void testDefaultAdminUserHasAdminRole() {
        ...
        assertEquals(1, set.size());        
        assertTrue(set.contains("ROLE_ADMIN"));
        System.out.println("Completed test: testDefaultAdminUserHasAdminRole");
    }
    ...
    public void testItemInsertAndCounts() {
        ...
        System.out.println("Completed test: testItemInsertAndCounts");
    }
    ...
    public void testRemoveSpaceRoleDoesNotOrphanDatabaseRecord() {
        ...
        cleanDatabase();
        System.out.println("Completed test: testRemoveSpaceRoleDoesNotOrphanDatabaseRecord");
    }
    ...
    public void testFindSpacesWhereGuestAllowed() {
        ...
        System.out.println("Completed test: testFindSpacesWhereGuestAllowed");
    }
    ...
    public void testRenameSpaceRole() {
        ...
        System.out.println("Completed test: testRenameSpaceRole");
    }
    ...
    public void testGetItemAsHtmlDoesNotThrowException() {
        ...
        System.out.println("Completed test: testGetItemAsHtmlDoesNotThrowException");
    }
    ...
    public void testDeleteItemThatHasRelatedItems() {
        ...
        System.out.println("Completed test: testDeleteItemThatHasRelatedItems");
    }        
    ...
    public void testLogicToFindNotUsersAndSpacesNotAllocated() {
        ...
        System.out.println("Completed test: testLogicToFindNotUsersAndSpacesNotAllocated");    
    }
    ...
    public void testFindSuperUsers() {                
        ...
        System.out.println("Completed test: testFindSuperUsers");
    }
    ...
    public void testLoadSpaceRolesMapForUser() {
        ...
        System.out.println("Completed test: testLoadSpaceRolesMapForUser");   
    }
    ...
    protected void onTearDown() throws Exception {
    	...
    	super.onTearDown();
    	//Thread.sleep(10);
    	System.out.println("USERS COUNT: "+countRowsInTable("users"));
    	System.out.println("SPACES COUNT: "+countRowsInTable("spaces"));
    }
